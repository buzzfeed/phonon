...
class ProcessTest(unittest.TestCase):
    ...
    def test_heartbeat_updates(self):
        ...
        assert parser.parse(new_time) >= parser.parse(current_time) + datetime.timedelta(seconds=p.heartbeat_interval)
    ...
    def test_multiple_heartbeats_update(self):
        ...
        assert parser.parse(new_time_1) >= parser.parse(current_time_1) + datetime.timedelta(seconds=p1.heartbeat_interval)
        assert parser.parse(new_time_2) >= parser.parse(current_time_2) + datetime.timedelta(seconds=p2.heartbeat_interval)
        assert parser.parse(new_time_3) >= parser.parse(current_time_3) + datetime.timedelta(seconds=p3.heartbeat_interval)
